...
knitr::opts_chunk$set(echo = TRUE, fig.width = 5, fig.height = 3) # root.dir = "~/GitHub/leaflet-trainr/" ... currently not sure how to reliably get Knitr to respect this identification of root.directory. See https://github.com/yihui/knitr/issues/277
library(leaflet)
library(rgdal)
library(readxl)
...
#tractData <- read.dbf("../data/CensusTracts_acsMerge.dbf")
